# CCDC154 (C16orf29) - Testis-Enriched Golgi Coiled-Coil Protein with Clinical Variants
...
## Evidence
```
Evidence: UniProt A6NI56, InterPro coiled-coil domains (11-667aa), STRING PPI network, HPA Golgi/testis expression, ClinVar 47 pathogenic variants, BLAST 66.9% mouse ortholog conservation
```
