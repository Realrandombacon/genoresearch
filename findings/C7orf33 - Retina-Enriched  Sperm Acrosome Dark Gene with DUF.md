# C7orf33 - Retina-Enriched & Sperm Acrosome Dark Gene with DUF5548
...
## Evidence
```
Evidence: UniProt Q8WU49 (177 aa), InterPro DUF5548 domain (1-177), BLAST human-specific (no cross-species hits), HPA retina enrichment (1.3 nTPM), Acrosome/equatorial segment localization, STRING interaction with IQCA1L (spermatogenesis/cilia)
```
