# C21orf58 - Ciliary Transition Zone Protein with Clinical Significance
...
## Evidence
```
InterPro: Proline-rich domain(84-148); HPA: ciliary transition zone + nuclear; ClinVar: 96 pathogenic variants; STRING: HEPACAM2/KCNQ1 interactions
```
