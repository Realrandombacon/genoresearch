# SUN Domain-Containing Ossification Factor (SUCO/C1ORF9): Nuclear Envelope Protein with Osteogenic Function and Disease-Associated Variants
...
## Evidence
```
InterPro: IPR012919 (SUN domain), IPR008979 (Galactose-binding-like), PF07738 (Sad1/UNC-like C-terminal), IPR045120 (SUCO/Slp1-like family); STRING: MYL3(0.890), HIF1A(0.870), FCGRT(0.735), EP300(0.687), TAPT1(0.686), EPAS1(0.663), HSP90AA1(0.656), AHSA1(0.640), P4HB(0.635), ARHGAP33(0.618); HPA: bone marrow 78.7 nTPM, tissue enhanced, detected in all tissues, nucleoli fibrillar center + cytosol; ClinVar: 45 pathogenic variants including c.3431A>G (p.Gln1144Arg), c.2038C>A (p.Pro680Thr), c.1819C>A (p.Pro607Thr), c.1058T>C (p.Ile353Thr), CNV losses/gains 1q21-q31; AlphaFold: pLDDT 52.4 (medium), 1-1254 aa modeled; UniProt: Q9UBS9
```
