# CXorf58 - Mitochondrial Fission Inhibitor with 152 Pathogenic Variants
...
## Evidence
```
Evidence: gene_info (Xp22.11 location), uniprot_fetch (Q96LI9, 332aa), blast_search (mouse ortholog 56.3%, MFI/C11orf65 homology), interpro_scan (PTHR33504 Mitochondrial Fission Inhibitor domain), string_interactions (10 partners), hpa_expression (testis-enriched, nucleoplasm), clinvar_search (152 pathogenic variants)
```
