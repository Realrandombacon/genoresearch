# C11orf3/EMC7 - NOT A DARK GENE: Well-Characterized ER Membrane Protein Complex Subunit
...
## Evidence
```
Evidence: gene_info(GeneID:739, 11q13, alias ANG3), uniprot_fetch(Q9NPA0, 242aa), analyze_sequence(22.7% charged, 41.7% hydrophobic), interpro_scan(beta-sandwich IPR019008, carbohydrate-binding IPR013784), blast_search(39.7% C.elegans, 28.5% A.thaliana), string_interactions(EMC1-10 all 0.999, MMGT1 0.999, C1orf43 0.825), hpa_expression(detected in all tissues, low specificity)
```
