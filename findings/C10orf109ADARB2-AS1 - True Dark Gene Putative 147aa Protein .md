# C10orf109/ADARB2-AS1 - True Dark Gene: Putative 147aa Protein with No Functional Evidence
...
## Evidence
```
Evidence: UniProt A8MUL3 (147aa), BLAST self-hit only, InterPro scan failed, STRING no interactions, HPA no expression data
```
