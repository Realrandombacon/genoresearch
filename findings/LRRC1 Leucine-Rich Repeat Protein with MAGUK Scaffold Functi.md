# LRRC1: Leucine-Rich Repeat Protein with MAGUK Scaffold Function and Neuronal Interaction Partners
...
## Evidence
```
InterPro: IPR001611, IPR003591, IPR050614, PTHR23119, G3DSA:3.80.10.10 (aa 1-512); STRING: DLG4(0.771), ADGRL1(0.614), TINAG(0.592), ADGRL2(0.553), ADGRL3(0.545); HPA: cytosol, detected in many tissues; ClinVar: 13 pathogenic variants (6p12.1 CNVs); AlphaFold: pLDDT 85.8; UniProt: Q9BTT6 (524 aa); Conservation: mouse Q80VQ1 (524 aa)
```
