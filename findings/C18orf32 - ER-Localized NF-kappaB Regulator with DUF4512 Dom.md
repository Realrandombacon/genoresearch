# C18orf32 - ER-Localized NF-kappaB Regulator with DUF4512 Domain
...
## Evidence
```
Evidence: gene_info (ER/lipid droplet location, NF-kappaB regulation), uniprot_fetch (Q8TCD1, 76aa), interpro_scan (DUF4512 domain IPR026776), string_interactions (10 partners incl mitochondrial proteins), hpa_expression (ubiquitous, vesicles), clinvar_search (39 pathogenic variants)
```
