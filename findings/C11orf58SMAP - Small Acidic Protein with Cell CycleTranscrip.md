# C11orf58/SMAP - Small Acidic Protein with Cell Cycle/Transcription Network
...
## Evidence
```
Evidence: UniProt O00193, InterPro PF15477 Small acidic protein, AlphaFold pLDDT 65.4, HPA ubiquitous/nucleoplasm+ER, STRING SKP1+SUB1+cell cycle network, ClinVar 13 pathogenic CNVs, gene_info 11p15.2/SMAP/Hero20
```
