# TMEM204 C16orf30 - High-Confidence Transmembrane Protein with DNA Damage Response and Immune Cell Expression
...
## Evidence
```
InterPro domains: IPR038992 (Transmembrane protein 204 family), PTHR14627 (TMEM204), G3DSA:1.20.140.150 (CATH superfamily); STRING partners: ATR (0.760), KIAA1143 (0.721), FLT4 (0.611), TJP1 (0.596), GIMAP7 (0.560), CLEC14A (0.541), SAMSN1 (0.515), KDR (0.512), KBTBD12 (0.508), ADGRF5 (0.489); HPA: predicted membrane proteins, transporters, stress response, immune cell enhanced, cell type enhanced; ClinVar: 46 pathogenic variants (CNVs, deletions, SNVs); AlphaFold: pLDDT 71.1 (high confidence, residues 1-226); UniProt: Q9BSN7, 226 aa
```
