# C2orf42 - Testis-Enriched Zinc-Finger Protein with 8 Pathogenic Variants
...
## Evidence
```
Evidence: gene_info (2p13.3, nucleoplasm), uniprot_fetch (Q9NWW7, 574aa), blast_search (98.8% macaque, 97.6% bovine, 91.6% mouse - exceptional conservation), interpro_scan (treble-clef zinc-finger IPR029269, C-terminal domain IPR060076), string_interactions (GOLGA6C, RSBN1L, ZNF79, ZNF557, ZSCAN32, ZBTB49, MYBBP1A - transcriptional network), hpa_expression (testis-enriched 55.2 nTPM, nucleoplasm), clinvar_search (8 pathogenic CNVs)
```
