# C1orf56/MENT - Testis-Enriched Secreted Proto-Oncogene
...
## Evidence
```
Evidence: gene_info(GeneID:54964), uniprot(Q9BUN1), interpro(MENT IPR029292, MIS1 PF15322), hpa(testis-enriched 71.9 nTPM, secreted), string(2 interactions: CDC42SE1, NOXRED1), blast(mammalian conservation)
```
