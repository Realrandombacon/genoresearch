# C14orf23/LINC01551 - True Dark Gene with Uncharacterized 167aa Protein
...
## Evidence
```
Evidence: 1) NCBI Gene ID 145299 2) UniProt Q86U37 - Uncharacterized protein 167aa 3) BLAST: only self-hit 100% identity 4) No HPA expression 5) No STRING interactions 6) InterPro scan failed 7) No PubMed publications
```
