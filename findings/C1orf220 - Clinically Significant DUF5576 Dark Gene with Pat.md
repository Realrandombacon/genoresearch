# C1orf220 - Clinically Significant DUF5576 Dark Gene with Pathogenic Variants
...
## Evidence
```
Evidence: gene_info(C1orf220), uniprot(Q5T0J3-134aa), blast_search(self-only), interpro_scan(DUF5576), hpa_expression(no data), string_interactions(none), clinvar_search(8 pathogenic variants)
```
