# C14orf132 - Brain-Enriched Small Membrane Protein in Dark Gene Network
...
## Evidence
```
UniProt:Q9NPU4, BLAST:human-only, InterPro:C14orf132-domain, HPA:brain-enriched+membrane, STRING:dark-gene-network
```
